...
#display
suxwigb < $output_bpf title="BPF: $bpf" perc=97 style=vsp key=gelev label2="depth" label1="twt (s)"&
suxwigb < $output_norm title="BPF: $bpf + Normalize by RMS" perc=97 style=vsp key=gelev label2="depth" label1="twt (s)" &
suxwigb < $output_tvg title="BPF: $bpf + Normalize by RMS + Gain ($tpow)" perc=97 style=vsp key=gelev label2="depth" label1="twt (s)"&
